...
<p align="center">
  <a href="https://linkedin.com/in/ashutosh7i">
    <img src="https://skillicons.dev/icons?i=cpp,java,python,html,css,js,php,mysql,postgres,mongodb,arduino,linux,bash,git,github,react,express,nodejs,tailwind,electron,azure,gcp,nginx,docker,vscode,postman,powershell,ipfs,githubactions,raspberrypi&theme=dark&perline=10" />
  </a>
</p>
